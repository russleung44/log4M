...
(
    ...
    REMARK               CHARACTER VARYING(255) DEFAULT '',
...
ALTER TABLE BILL
    ADD COLUMN IF NOT EXISTS REMARK CHARACTER VARYING(255) DEFAULT '' AFTER NOTE;
...
(
    CATEGORY_KEYWORD_ID INTEGER AUTO_INCREMENT,
    CATEGORY_NAME       CHARACTER VARYING(255)                NOT NULL,
    KEYWORD             CHARACTER VARYING(255)                NOT NULL,
    IGNORE_CASE         TINYINT        DEFAULT 0              NOT NULL,
    SORT                INTEGER        DEFAULT 99             NOT NULL,
    DELETED             TINYINT        DEFAULT 0              NOT NULL,
    CR_TIME             TIMESTAMP      DEFAULT LOCALTIMESTAMP NOT NULL,
    MD_TIME             TIMESTAMP      DEFAULT LOCALTIMESTAMP NOT NULL,
    PRIMARY KEY (CATEGORY_KEYWORD_ID),
