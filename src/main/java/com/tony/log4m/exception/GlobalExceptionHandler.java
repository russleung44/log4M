...
public class GlobalExceptionHandler {
    ...
    public void noHttpResponseException(NoHttpResponseException e) {
        log.error("NoHttpResponseException:{}", e.getMessage());
    }
    ...
    public R handleSaTokenException(SaTokenException e, HttpServletRequest request) {
        log.error("认证异常:{} URL:{}", e.getMessage(), request.getRequestURL());
